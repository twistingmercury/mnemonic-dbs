...
//
// This migration establishes uniqueness constraints for the two
// node types in the knowledge graph: Pattern and Concept.
...
//   pattern_id_unique, concept_name_unique
//
// Manual application:
